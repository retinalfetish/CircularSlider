...
## Getting Started
The latest build is available at Maven Central (a default repository) and also [JitPack](https://jitpack.io/#com.unary/circularslider).  Simply add the the library dependency to your app `build.gradle.kts`.
```
dependencies {
    // ...
